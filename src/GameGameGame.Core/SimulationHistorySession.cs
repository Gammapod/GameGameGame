...
public sealed class SimulationHistorySession
{
        ...
        ControlledActorCommand command)
    {
        ...
        RecordSuccessfulControlledResult(fromFrameIndex, result);
    ...
    public ControlledActorCommandResult SubmitPickupActionChoice(
        ActionChoiceService choices,
        ActionChoiceRequest request,
        EntityId targetId,
        ...
        SubmitActionChoiceResult(
            request,
            () => choices.SubmitPickupChoice(World, request, targetId, destination, actionPlans, beforePlan));

    public ControlledActorCommandResult SubmitDropActionChoice(
        ActionChoiceService choices,
        ActionChoiceRequest request,
        EntityId targetId,
        PlaneCoord destination,
    ...
    public ControlledActorCommandResult SubmitEnterActionChoice(
        ActionChoiceService choices,
        ActionChoiceRequest request,
        EntityId targetId,
        IReadOnlyDictionary<EntityId, IEntityActionPlan> actionPlans,
        ...
        SubmitActionChoiceResult(
            request,
            () => choices.SubmitEnterChoice(World, request, targetId, actionPlans, beforePlan));

    public ControlledActorCommandResult SubmitExitActionChoice(
        ActionChoiceService choices,
        ActionChoiceRequest request,
        Direction direction,
        IReadOnlyDictionary<EntityId, IEntityActionPlan> actionPlans,
    ...
    public ControlledActorCommandResult SubmitPushActionChoice(
        ActionChoiceService choices,
        ActionChoiceRequest request,
        EntityId targetId,
        Direction direction,
        ...
        SubmitActionChoiceResult(
            request,
            () => choices.SubmitPushChoice(World, request, targetId, direction, actionPlans, beforePlan));
    ...
    private void RecordSuccessfulControlledResult(int fromFrameIndex, ControlledActorCommandResult result)
    {
