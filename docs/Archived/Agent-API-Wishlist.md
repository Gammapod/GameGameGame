...
Status: Archived wishlist / backlog reference, not an active implementation plan. Promote items only through the active roadmap when frontend/editor-browser work needs them.
