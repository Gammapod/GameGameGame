...
4. promote/harden the next broad action pair, likely `EnterTarget`/`ExitFacing`, before adding ranged transform variants such as Throw/Shove unless scenario pressure promotes them sooner;
